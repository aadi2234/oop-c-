//Practical No.13-2
/*Program-2 To implement Hybrid Inheritance with Virtual Base class Cricketer ->
Bowler,Batsman -> All Rounder classes*/
//Class:SYCM-II      Roll no:03      Batch:A      Course:OOP
#include <iostream>
using namespace std;
